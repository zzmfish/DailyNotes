var store = [{
        ...
        "tags": [],
        "url": "/DailyNotes/2020/11/21/RPM%E8%BD%AF%E4%BB%B6%E7%AE%A1%E7%90%86.html",
        "teaser": null
      },{
        "title": "C++",
        "excerpt":"使用ofstream写文件  #include &lt;iostream&gt; #include &lt;fstream&gt; using namespace std;  int main () {   ofstream myfile;   myfile.open (\"example.txt\");   myfile &lt;&lt; \"Writing this to a file.\\n\";   myfile.close();   return 0; }   日期时间  //返回当前unix时间戳 #include &lt;time.h&gt; time_t time (time_t* timer);  ","categories": [],
        "tags": [],
        "url": "/DailyNotes/2020/11/26/C++.html",
        "teaser": null
      },{
        "title": "gRPC",
        ...
        "tags": [],
        "url": "/DailyNotes/2020/12/19/JavaScript.html",
        "teaser": null
      },{
        "title": "SSH",
        ...
        "tags": [],
        "url": "/DailyNotes/2020/12/19/SSH.html",
        "teaser": null
      },{
        "title": "软件",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/01/08/%E8%BD%AF%E4%BB%B6.html",
        "teaser": null
      },{
        "title": "0临时",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/01/23/Bash.html",
        "teaser": null
      },{
        "title": "MongoDB",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/01/27/Redis.html",
        "teaser": null
      },{
        "title": "Bazel",
        "excerpt":"概念 Workspace 包含软件源代码 包含输出目录的符号链接 包含WORKSPACE文件指明外部依赖 包含WORKSPACE文件的目录是workspace的根目录 忽略子目录的WORKSPACE文件 可以是WORKSPACE.bazel Repositories 仓库用来组织代码 根目录又称主仓库或@ 外部仓库（external）在WORKSPACE中定义 Packages 目录包含BUILD或BUILD.bazel文件 文件和依赖关系的集合 Targets package包含的元素，主要是文件或规则 Labels target的名称，格式为@repositrory_name//package_name:target_name： @myrepo//my/app/main:app_binary //my/app/main:app_binary #同一个仓库 //my/app:app //my/app #同上 Rules 指明输入文件和输出文件的关系 生成输出文件的步骤 WORKSPACE规则 Workspace规则主要用来解决外部依赖 bind 在//external中为目标指定一个别名。不推荐使用。 local_repository 引用其他目录中的目标 local_repository( name = \"my-ssl\", path = \"/home/user/ssl\", ) 可以指定@my-ssl//src:openssl-lib作为这个库的依赖。 new_local_repository 把本地目录变成一个Bazel仓库。 比如聊天app代码目录在/chat-app，要用的SSL库在～/ssl。 1、添加~/chat-app/BUILD.my-ssl： java_library( name =...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/02/Bazel.html",
        "teaser": null
      },{
        "title": "CSS",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/03/CSS.html",
        "teaser": null
      },{
        "title": "第一本无人驾驶技术书：08 无人驾驶的行为预测",
        "excerpt":"总体架构   感知      定位服务：无人车主车本身在哪里   高精地图：配合定位模块提供定位地图；对感知模块的先验补充   环境感知：利用传感器得到的实时数据，检测和追踪周边物体   行为预测   规划控制（广义）      行为预测：基于感知模块的检测结果，最这些物体的短时间未来行为作出预测   路由导航   行为决策   动作规划   低层控制   分类问题   问题拆解   车辆是否会沿某一特定道路序列行进   特征设计   数据帧概念：某一个时刻t对应的所有已知最新数据      预测目标车辆的历史属性            时刻t对应的位置、速度、姿态       时间窗口[t-w, t-1]内的运动属性       时间窗口内行驶所遵循的道路序列的形状特征           预测目标道路序列的属性            均匀抽取样点       朝向、曲率、与道路边界的距离           周边物体的特征            前车和后车距离目标车辆投影位置的距离       前车和后车的横向位置、速度及朝向           无人车主车的规划结果            目标车辆的周边物体       自身行为是已知的              模型选择      无记忆模型            SVM、DNN       把历史行为设计成特征           有记忆模型            RNN的LSTM           预测轨迹      预测轨迹的方法            卡尔曼滤波       机器学习           核心是给下游决策模块提供安全可靠的保护边界   在行为层面的准确率远大于轨迹层面的精确性   用规划模块的简单版本计算周边目标车辆的预测轨迹   ","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/03/%E7%AC%AC%E4%B8%80%E6%9C%AC%E6%97%A0%E4%BA%BA%E9%A9%BE%E9%A9%B6%E6%8A%80%E6%9C%AF%E4%B9%A6-08-%E6%97%A0%E4%BA%BA%E9%A9%BE%E9%A9%B6%E7%9A%84%E8%A1%8C%E4%B8%BA%E9%A2%84%E6%B5%8B.html",
        "teaser": null
      },{
        "title": "人性的弱点",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/04/%E4%BA%BA%E6%80%A7%E7%9A%84%E5%BC%B1%E7%82%B9.html",
        "teaser": null
      },{
        "title": "代码大全2",
        "excerpt":"《代码大全2》读书笔记 软件构建中的设计 要避免做出“聪明”的设计。应该做出简单且易于理解的设计。 高扇入是让大量的类使用某个给定的类。 低扇出是让一个类里少量或适中地使用其他的类。 尽量使用标准的、常用的方法，让整个系统给人一种熟悉的感觉。 通过限制子系统之间的通信来让每个子系统更有存在意义。 类 抽象数据类型指一些数据以及对这些数据所进行操作的集合。 继承给程序增加了复杂度，因此它是一种危险的技术。 高质量的子程序 内聚性是指子程序中各种操作之间联系的紧密程序。 功能上的内聚性 是说一个子程序仅执行一项操作。 防御式编程 子程序应该不因传入错误数据而被破坏，哪怕是由其他子程序产生的错误数据。 伪代码编程过程 使用变量的一般事项 把一个变量的引用点尽可能集中在一起。 尽可能缩短变量的存活时间。 变量名 一个好记的名字反映的通常都是问题，而不是解决方案。 命名规则的存在为你的代码增加了结构，减少了你需要考虑的事情。 基本数据类型 浮点数避免等量判断。 把布尔表达式的结果付给一个变量，从而使得这一判断的含义变得更加明显。 不常见的数据类型 把指针操作限制在子程序或者类里面。 全局变量破坏了模块化和智力上的可管理性。 直线型代码 让程序易于自上而下阅读，而不是让读者的目光跳来跳去。 条件语句 控制循环 注意三种情况：开始的情况，任意选择的中间情况，以及最终的情况。 把嵌套限制在3层以内。 不常见的控制结构 把递归限制在一个子程序内。循环递归（A -&gt; B -&gt; C -&gt; A）非常危险，因为它很难检查。 goto会破坏代码应该严格自上而下运行的原则。 表驱动法 一般控制问题 复杂的代码表明你还没有充分地理解你的程序，所以无法简化它。 结构化编程的核心思想就是一个应用程序应该只采用一些单入单出的控制结构。 软件质量概述 提高生产效率和改善质量的最佳途径就是减少花在代码返工上的时间。...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/04/%E4%BB%A3%E7%A0%81%E5%A4%A7%E5%85%A82.html",
        "teaser": null
      },{
        "title": "大数据时代",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/04/%E5%A4%A7%E6%95%B0%E6%8D%AE%E6%97%B6%E4%BB%A3.html",
        "teaser": null
      },{
        "title": "日本移动互联网兴衰启示录",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/04/%E6%97%A5%E6%9C%AC%E7%A7%BB%E5%8A%A8%E4%BA%92%E8%81%94%E7%BD%91%E5%85%B4%E8%A1%B0%E5%90%AF%E7%A4%BA%E5%BD%95.html",
        "teaser": null
      },{
        "title": "特殊符号",
        "excerpt":"常用符号大全 ❤❥웃유♋☮✌☏☢☠✔☑♚▲♪✈✞÷↑↓◆◇⊙■□△▽¿─│♥❣♂♀☿Ⓐ✍✉☣☤✘☒♛▼♫⌘☪≈←→◈◎☉★☆⊿※¡━┃♡ღツ☼☁❅♒✎©®™Σ✪✯☭➳卐√↖↗●◐Θ◤◥︻〖〗┄┆℃℉°✿ϟ☃☂✄¢€£∞✫★½✡×↙↘○◑⊕◣◢︼【】┅┇☽☾✚〓▂▃▄▅▆▇█▉▊▋▌▍▎▏↔↕☽☾の•▸◂▴▾┈┊①②③④⑤⑥⑦⑧⑨⑩ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩ㍿▓♨♛❖♓☪✙┉┋☹☺☻تヅツッシÜϡﭢ™℠℗©®♥❤❥❣❦❧♡۵웃유ღ♋♂♀☿☼☀☁☂☄☾☽❄☃☈⊙☉℃℉❅✺ϟ☇♤♧♡♢♠♣♥♦☜☞☝✍☚☛☟✌✽✾✿❁❃❋❀⚘☑✓✔√☐☒✗✘ㄨ✕✖✖⋆✢✣✤✥❋✦✧✩✰✪✫✬✭✮✯❂✡★✱✲✳✴✵✶✷✸✹✺✻✼❄❅❆❇❈❉❊†☨✞✝☥☦☓☩☯☧☬☸✡♁✙♆。，、＇：∶；?‘’“”〝〞ˆˇ﹕︰﹔﹖﹑•¨….¸;！´？！～—ˉ｜‖＂〃｀@﹫¡¿﹏﹋﹌︴々﹟#﹩$﹠&amp;﹪%*﹡﹢﹦﹤‐￣¯―﹨ˆ˜﹍﹎+=&lt;＿-\\ˇ~﹉﹊（）〈〉‹›﹛﹜『』〖〗［］《》〔〕{}「」【】︵︷︿︹︽﹁﹃︻︶︸﹀︺︾ˉ﹂﹄︼☩☨☦✞✛✜✝✙✠✚†‡◉○◌◍◎●◐◑◒◓◔◕◖◗❂☢⊗⊙◘◙◍⅟½⅓⅕⅙⅛⅔⅖⅚⅜¾⅗⅝⅞⅘≂≃≄≅≆≇≈≉≊≋≌≍≎≏≐≑≒≓≔≕≖≗≘≙≚≛≜≝≞≟≠≡≢≣≤
₪₵元₣₱฿¤₡₮₭₩ރ円₢₥₫₦zł﷼₠₧₯₨Kčर₹ƒ₸￠ 箭头符号 ↑↓←→↖↗↘↙↔↕➻➼➽➸➳➺➻➴➵➶➷➹▶►▷◁◀◄«»➩➪➫➬➭➮➯➱⏎➲➾➔➘➙➚➛➜➝➞➟➠➡➢➣➤➥➦➧➨↚↛↜↝↞↟↠↠↡↢↣↤↤↥↦↧↨⇄⇅⇆⇇⇈⇉⇊⇋⇌⇍⇎⇏⇐⇑⇒⇓⇔⇖⇗⇘⇙⇜↩↪↫↬↭↮↯↰↱↲↳↴↵↶↷↸↹☇☈↼↽↾↿⇀⇁⇂⇃⇞⇟⇠⇡⇢⇣⇤⇥⇦⇧⇨⇩⇪↺↻⇚⇛♐ 符号图案 ✐✎✏✑✒✍✉✁✂✃✄✆✉☎☏☑✓✔√☐☒✗✘ㄨ✕✖✖☢☠☣✈★☆✡囍㍿☯☰☲☱☴☵☶☳☷☜☞☝✍☚☛☟✌♤♧♡♢♠♣♥♦☀☁☂❄☃♨웃유❖☽☾☪✿♂♀✪✯☭➳卍卐√×■◆●○◐◑✙☺☻❀⚘♔♕♖♗♘♙♚♛♜♝♞♟♧♡♂♀♠♣♥❤☜☞☎☏⊙◎☺☻☼▧▨♨◐◑↔↕▪▒◊◦▣▤▥▦▩◘◈◇♬♪♩♭♪の★☆→あぃ￡Ю〓§♤♥▶¤✲❈✿✲❈➹☀☂☁【】┱┲❣✚✪✣✤✥✦❉❥❦❧❃❂❁❀✄☪☣☢☠☭ღ▶▷◀◁☀☁☂☃☄★☆☇☈⊙☊☋☌☍ⓛⓞⓥⓔ╬『』∴☀♫♬♩♭♪☆∷﹌の★◎▶☺☻►◄▧▨♨◐◑↔↕↘▀▄█▌◦☼♪の☆→♧ぃ￡❤▒▬♦◊◦♠♣▣۰•❤•۰►◄▧▨♨◐◑↔↕▪▫☼♦⊙●○①⊕◎Θ⊙¤㊣★☆♀◆◇◣◢◥▲▼△▽⊿◤◥✐✌✍✡✓✔✕✖♂♀♥♡☜☞☎☏⊙◎☺☻►◄▧▨♨◐◑↔↕♥♡▪▫☼♦▀▄█▌▐░▒▬♦◊◘◙◦☼♠♣▣▤▥▦▩◘◙◈♫♬♪♩♭♪✄☪☣☢☠♯♩♪♫♬♭♮☎☏☪♈ºº₪¤큐«»™♂✿♥　◕‿-｡　｡◕‿◕｡ 希腊字母 ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζνξοπρσηθικλμτυφχψω 俄语字母 АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя 汉语拼音 āáǎàōóǒòēéěèīíǐìūúǔùǖǘǚǜüêɑńňɡㄅㄆㄇㄈㄉㄊㄋㄌㄍㄎㄏㄐㄑㄒㄓㄔㄕㄖㄗㄘㄙㄚㄛㄜㄝㄞㄟㄠㄡㄢㄣㄤㄥㄦㄧㄨㄩ 中文字符 零壹贰叁肆伍陆柒捌玖拾佰仟万亿吉太拍艾分厘毫微卍卐卄巜弍弎弐朤氺曱甴囍兀々〆のぁ〡〢〣〤〥〦〧〨〩㊎㊍㊌㊋㊏㊚㊛㊐㊊㊣㊤㊥㊦㊧㊨㊒㊫㊑㊓㊔㊕㊖㊗㊘㊜㊝㊞㊟㊠㊡㊢㊩㊪㊬㊭㊮㊯㊰㊀㊁㊂㊃㊄㊅㊆㊇㊈㊉ 日文平假名片假名 ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわゐゑをんゔゕゖァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヰヱヲンヴヵヶヷヸヹヺ・ーヽヾヿ゠ㇰㇱㇲㇳㇴㇵㇶㇷㇸㇹㇺㇻㇼㇽㇾㇿ 制表符 ─ ━│┃╌╍╎╏┄ ┅┆┇┈ ┉┊┋┌┍┎┏┐┑┒┓└ ┕┖┗ ┘┙┚┛├┝┞┟┠┡┢┣ ┤┥┦┧┨┩┪┫┬ ┭ ┮ ┯ ┰ ┱ ┲ ┳ ┴ ┵ ┶ ┷ ┸...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/05/%E7%89%B9%E6%AE%8A%E7%AC%A6%E5%8F%B7.html",
        "teaser": null
      },{
        "title": "PostgreSQL数据类型",
        "excerpt":"数值类型 smallint: 2 字节 integer: 4 字节 bigint: 8 字节 decimal: 可变长度，用户指定精度 numeric: 同decimal real: 4字节，6位数字精度 double precision: 8字节，15位数字精度 smallserial: 2字节自增 serial: 4字节自增 bigserial: 8字节自增 money: 存储货币量；8字节，小数位数固定 字符类型 character varying(n), varchar(n): 可变长度，但有限制 character(n), char(n): 定长，用空格填充 text: 无限制可变长度 bytea: 存储二进制字符串 日期时间类型（p表示秒后面保留小数位数） timestamp [ ( p ) ]：日期和时间 timestamp [ ( p...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/08/PostgreSQL%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B.html",
        "teaser": null
      },{
        "title": "面试问题",
        ...
        "title": "单词",
        "excerpt":"A ♥ accommodate vi. 容纳；适应 ✍ This hotel can accommodate up to 500 guests. accomplish vt. 完成；实现 ✍ I have accomplished a great deal in the last few months. adorn [ə’dɔːrn] v. 装饰 adj. 装饰的 ✍ She likes to adorn herself with jewels. algebra [‘ældʒɪbrə] n. 代数学 ♥ ancillary adj....","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/09/%E5%8D%95%E8%AF%8D.html",
        "teaser": null
      },{
        "title": "程序员的思维修炼",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/09/%E7%A8%8B%E5%BA%8F%E5%91%98%E7%9A%84%E6%80%9D%E7%BB%B4%E4%BF%AE%E7%82%BC.html",
        "teaser": null
      },{
        "title": "自控力：01 什么是自控力",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/09/%E8%87%AA%E6%8E%A7%E5%8A%9B-01-%E4%BB%80%E4%B9%88%E6%98%AF%E8%87%AA%E6%8E%A7%E5%8A%9B.html",
        "teaser": null
      },{
        "title": "自控力：02 意志力的本能",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/12/%E8%87%AA%E6%8E%A7%E5%8A%9B-02-%E6%84%8F%E5%BF%97%E5%8A%9B%E7%9A%84%E6%9C%AC%E8%83%BD.html",
        "teaser": null
      },{
        "title": "Kubernetes",
        "excerpt":"概述 是什么 管理容器化的工作负载和服务的的开源平台 组件 一个K8s集群由一组机器组成 Node表示一个机器 Pod表示一个应用负载 Control Plane管理集群的Node和Pod Control Plane 组件 kube-apiserver: 公开了 Kubernetes API etcd: 保存集群数据的键值数据库 kube-scheduler: 为新创建的Pod选择运行的Node kube-controller-manager cloud-controller-manager: 特定云平台的控制组建 Node 组件 kubelet: 保证容器都运行在 Pod 中 kube-proxy: 维护节点的网络规则 Container Runtime: 负责运行容器的软件（如Docker） 入门 minikube # 启动minikube minikube start # 显示节点IP地址 minikube ip # 打开仪表板 minikube dashboard # 停止minukube...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/22/Kubernetes.html",
        "teaser": null
      },{
        "title": "Nginx",
        "excerpt":"命令 nginx nginx -s quit nginx -s reload 安装文件位置（Ubuntu） # 配置文件 /etc/nginx/nginx.conf # 静态网页 /var/www/html/ 配置文件 http {     # 上传大小限制     client_max_body_size 8M;     client_body_buffer_size 128k; # 列出目录文件 autoindex on; charset utf-8;     server {         listen  80;        ...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/22/Nginx.html",
        "teaser": null
      },{
        "title": "PostgreSQL",
        "excerpt":"安装 初始化 安装完毕后，系统会创建一个数据库超级用户 postgres，密码为空。 sudo -i -u postgres 这时使用以下命令进入 postgres，输出以下信息，说明安装成功： ~$ psql psql (9.5.17) Type \"help\" for help. postgres=# 为postgres用户设置一个密码。 \\password postgres 输入以下命令退出 PostgreSQL 提示符： \\q 允许远程访问 编辑 /etc/postgresql/13/main/postgresql.conf #listen_addresses = 'localhost' listen_addresses = '*' 编辑 /etc/postgresql/13/main/pg_hba.conf # IPv4 local connections: #host all all 127.0.0.1/32 md5 host all all 0.0.0.0/0...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/22/PostgreSQL.html",
        "teaser": null
      },{
        "title": "中国省市县级区行政地图",
        "excerpt":"  ","categories": [],
        ...
        "excerpt":"  ","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/22/%E5%88%BB%E6%84%8F%E7%BB%83%E4%B9%A0%E6%80%9D%E7%BB%B4%E5%AF%BC%E5%9B%BE.html",
        "teaser": null
      },{
        "title": "自动驾驶汽车技术",
        "excerpt":"  ","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/22/%E8%87%AA%E5%8A%A8%E9%A9%BE%E9%A9%B6%E6%B1%BD%E8%BD%A6%E6%8A%80%E6%9C%AF.html",
        "teaser": null
      },{
        "title": "Tmux",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/23/Tmux.html",
        "teaser": null
      },{
        "title": "Git",
        "excerpt":"主要命令 add apply git apply $patch_file bisect branch #显示当前分支 git branch --show-current #删除本地分支 git branch -d $branch_name #显示全部分支 git branch -a #显示远程分支 git branch -r checkout # 新建分支 git checkout -b $branch_name # 解决冲突状态：使用对方的修改 git checkout --theirs . # 撤销未完成的merge（merge时所在的分支） git checkout $branch_name # 检出某个版本的文件 git checkout $commit_id $file_name git...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/24/Git.html",
        "teaser": null
      },{
        "title": "Docker",
        "excerpt":"问题 数据存放位置（镜像、容器） /var/lib/docker docker bash无法输入中文 docker exec -it b18f56aa1e15 env LANG=C.UTF-8 /bin/bash 查看container占用的磁盘大小 docker ps --size 重启docker服务 # ubuntu sudo systemctl restart docker 使用私有仓库 # 运行容器 docker run -d -p 5000:5000 --restart=always --name registry registry # 推送到私有仓库（只能推送到127.0.0.1） docker tag $image_id 127.0.0.1:5000/$repo_name:$tag_name docker push 127.0.0.1:5000/$repo_name:$tag_name # 查看仓库中的镜像 curl '127.0.0.1:5000/v2/_catalog' 命令 attach...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/25/Docker.html",
        "teaser": null
      },{
        "title": "Linux",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/25/Linux.html",
        "teaser": null
      },{
        "title": "Linux命令",
        "excerpt":"   ](http://vbird.dic.ksu.edu.tw/linux_server/0140networkcommand/0140networkcommand-centos4.php)  ","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/25/Linux%E5%91%BD%E4%BB%A4.html",
        "teaser": null
      },{
        "title": "Python2",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/02/26/Python2.html",
        "teaser": null
      },{
        "title": "Python3",
        "excerpt":"编译安装 sudo apt install libssl-dev libffi-dev libbz2-dev libncurses5-dev libncursesw5-dev ./configure --prefix=$prefix #打开config.log查找ssl、ffi是否成功 make make install 参数解释 import argparse parser = argparse.ArgumentParser() #--job或-j，整数类型，必需 parser.add_argument('--job_id', '-j', type=int, required=True) args = parser.parse_args() print(args.job_id) 日志输出 # 输出日志到文件 logging.basicConfig(filename='example.log', format='%(levelname)s:%(message)s', level=logging.DEBUG) # 输出日志到终端 logger = logging.getLogger() logger.addHandler(logging.StreamHandler(sys.stdout)) logger.setLevel(logging.DEBUG) # 根据日期切换日志文件 logging.basicConfig() file_handler = logging.handlers.TimedRotatingFileHandler(\"video.log\", 'MIDNIGHT')...","categories": [],
        "tags": [],
        "url": "/DailyNotes/2021/02/26/Python3.html",
        "teaser": null
      },{
        "title": "Jekyll",
        ...
        "tags": [],
        "url": "/DailyNotes/2021/03/02/Jekyll.html",
        "teaser": null
      }]
